...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [      
      ...
      ,{ path: 'auditoria-logins', component: AuditoriaComponent, data: { title: 'Auditoría Logins' }}
      ,{ path: 'auditoria-recuperacion', loadComponent: () => import('./demo/pages/auditoria-recuperacion/auditoria-recuperacion.component').then(m => m.AuditoriaRecuperacionComponent), data: { title: 'Auditoría Recuperación' }}
