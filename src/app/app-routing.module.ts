...
import { ChangePasswordComponent } from './demo/pages/change-password/change-password.component';
import { AuditLogsComponent } from './demo/pages/audit-logs/audit-logs.component';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'auditoria', component: AuditLogsComponent, data: { title: 'Auditoría' } }
    ]
  },
